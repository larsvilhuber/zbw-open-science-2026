---
title: "Open Science in Economics"
...
```{r, child=c("00-qrcode.qmd")}
```

```{r, child=c("00-follow-along.qmd")}
```

{{< include 01-problem.qmd >}}

{{< include 02-state-of-research.qmd >}}

{{< include 03-trace-framework.qmd >}}

{{< include 04-trov-tro.qmd >}}

{{< include 05-sivacor.qmd >}}

{{< include 07-development.qmd >}}